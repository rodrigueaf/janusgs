...
public class ObjectifController extends BaseEntityController<Objectif, Integer> {
    ...
    @RequestMapping(value = UrlConstants.Objectif.OBJECTIF_RACINE + "/liste/{id}", method = RequestMethod.GET)
    public ResponseEntity<Response> selectionnerListe(@PathVariable String id) {
        ...
        return new ResponseEntity<>(ResponseBuilder.success()
                ...
                .data(((IObjectifService) service).recupererLaListeVersionnee(ints))
